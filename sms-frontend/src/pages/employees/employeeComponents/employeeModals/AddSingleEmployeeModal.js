...
export const AddSingleEmployeeModal = ({addSingleEmployeeModalShow, setAddSingleEmployeeModalShow } ) => {

    const closeModal = () => {
        setAddSingleEmployeeModalShow(false)
    }

    
    return (
        <div className={addSingleEmployeeModalShow? `add-modal-underlay-active`: `add-modal-underlay-inactive`}>
            <div className="add-modal">
                <header className="add-header">
                    Add Employee <FaTimes className="add-close-icon" onClick={closeModal}/>
                </header>
                    ...
                    <form className="add-form">
                        <div className="input-groups">
                            ...
                            <div className="form-groups">
                                ...
                                <input type="date" placeholder="Date Joined" className="form-input" />
                            </div>
                        </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddSingleEmployeeModal)
